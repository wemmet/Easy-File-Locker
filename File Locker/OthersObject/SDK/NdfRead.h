...
/******************************************************************************************/
// 函数名       : NDF_GetDrmFileType
// 功能描述     : 得到NDF文件类型
// 参数			: szFile[IN]			NDF文件路径
// 返回值       : 参考 DRM_FILE_TYPE	
/******************************************************************************************/
int NDF_GetDrmFileType(const utf8* szFile);
...
/******************************************************************************************/
// 函数名       : NDF_GetPlayerRecorderProName
// 功能描述     : 获取禁止录制进程名称
// 参数			: szFile[IN]				NDF文件路径
//				: size[OUT]			    
// 	            : szRecoderProcessName[OUT]
// 返回值       : DWORD		=0  成功	
//							>0  失败
// 说明			: 先获取大小 再获取内容
/******************************************************************************************/
DWORD NDF_GetPlayerRecorderProName(const utf8* szFile, int*size, utf8* szRecoderProcessName);
