...
+(void)showTips:(NSString *)text {
    ...
    tips.textContainer.lineFragmentPadding = 20;
    tips.center = CGPointMake(kWIDTH/2.0, kHEIGHT/2.0);
    tips.contentInset = UIEdgeInsetsMake(commonInset, 0, commonInset, commonInset);
